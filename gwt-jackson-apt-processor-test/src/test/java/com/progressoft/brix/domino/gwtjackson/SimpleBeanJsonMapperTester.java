...
public final class SimpleBeanJsonMapperTester extends AbstractTester {
    ...
    private static final Logger LOGGER = Logger.getLogger(SimpleBeanJsonMapperTester.class.getName());
...
//        // Date
    ...
    public void testSerializeValue(ObjectWriterTester<SimpleBean> writer) {
        ...
        bean.setSqlTime(new Time(getUTCTime(2012, 8, 18, 15, 45, 56, 545)));
