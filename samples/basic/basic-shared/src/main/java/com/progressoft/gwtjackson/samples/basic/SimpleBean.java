...
public class SimpleBean {
    ...
    public String toString() {
        return "SimpleBean{" +
                ...
                ", enumArray=" + Arrays.toString(enumArray) +
                ", booleanPrimitiveArray=" + Arrays.toString(booleanPrimitiveArray) +
                ", bytePrimitiveArray=" + Arrays.toString(bytePrimitiveArray) +
                ", characterPrimitiveArray=" + Arrays.toString(characterPrimitiveArray) +
                ", doublePrimitiveArray=" + Arrays.toString(doublePrimitiveArray) +
                ", floatPrimitiveArray=" + Arrays.toString(floatPrimitiveArray) +
                ", integerPrimitiveArray=" + Arrays.toString(integerPrimitiveArray) +
                ", longPrimitiveArray=" + Arrays.toString(longPrimitiveArray) +
                ", shortPrimitiveArray=" + Arrays.toString(shortPrimitiveArray) +
                ", stringArray2d=" + Arrays.toString(stringArray2d) +
                ", enumArray2d=" + Arrays.toString(enumArray2d) +
                ", booleanPrimitiveArray2d=" + Arrays.toString(booleanPrimitiveArray2d) +
                ", bytePrimitiveArray2d=" + Arrays.toString(bytePrimitiveArray2d) +
                ", characterPrimitiveArray2d=" + Arrays.toString(characterPrimitiveArray2d) +
                ", doublePrimitiveArray2d=" + Arrays.toString(doublePrimitiveArray2d) +
                ", floatPrimitiveArray2d=" + Arrays.toString(floatPrimitiveArray2d) +
                ", integerPrimitiveArray2d=" + Arrays.toString(integerPrimitiveArray2d) +
                ", longPrimitiveArray2d=" + Arrays.toString(longPrimitiveArray2d) +
                ", shortPrimitiveArray2d=" + Arrays.toString(shortPrimitiveArray2d) +
                ", voidProperty=" + voidProperty +
                '}';
    }
}