...
public class App implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		// We can set the age of a widget by accessing its Element
		...
		class MyHandler implements ClickHandler, KeyUpHandler {
			...
			private void sendNameToServer() {
				...
				greetingRequest.name=nameField.getText();
				greetingRequest.age=10;
				greetingRequest.random=new Double(100);
				// First, we validate the input.
				errorLabel.setText("");
				String textToServer = GreetingRequest.MAPPER.write(greetingRequest);
				...
				greetingService.greetServer(textToServer,
						new AsyncCallback<String>() {
							...
							public void onSuccess(String response) {
								GreetingResponse result = GreetingResponse.MAPPER.read(response);
								dialogBox.setText("Remote Procedure Call");
								serverResponseLabel
