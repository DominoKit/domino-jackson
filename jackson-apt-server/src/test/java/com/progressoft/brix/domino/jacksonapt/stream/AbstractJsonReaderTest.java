...
import com.progressoft.brix.domino.jacksonapt.stream.impl.MalformedJsonException;
import com.progressoft.brix.domino.jacksonapt.stream.impl.StringReader;
...
import static com.progressoft.brix.domino.jacksonapt.stream.JsonToken.*;
import static org.assertj.core.api.Assertions.assertThat;
import static org.assertj.core.api.Fail.fail;

@SuppressWarnings("resource")
public abstract class AbstractJsonReaderTest extends JacksonTestCase {
	...
	public void testNextNumber() {
        ...
        assertThat(new BigInteger(Long.MIN_VALUE + "").subtract(BigInteger.ONE)).isEqualTo(reader.nextNumber());
        assertThat(Long.MAX_VALUE).isEqualTo(reader.nextNumber());
        assertThat(new BigInteger(Long.MAX_VALUE + "").add(BigInteger.ONE)).isEqualTo(reader.nextNumber());
        reader.endArray();
        assertThat(JsonToken.END_DOCUMENT).isEqualTo(reader.peek());
    }
