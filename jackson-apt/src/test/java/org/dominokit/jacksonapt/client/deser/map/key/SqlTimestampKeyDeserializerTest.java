...
import org.dominokit.jacksonapt.deser.map.key.BaseDateKeyDeserializer.SqlTimestampKeyDeserializer;
...
public class SqlTimestampKeyDeserializerTest extends AbstractKeyDeserializerTest<Timestamp> {
  ...
  public void testDeserializeValue() {
    ...
    assertDeserialization(
        new Timestamp(getUTCTime(2012, 8, 18, 15, 45, 56, 543)), "2012-08-18T17:45:56.543+02:00");
  }
}
