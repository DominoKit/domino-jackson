...
public abstract class AbstractBeanJsonSerializer<T> extends JsonSerializer<T>
  ...
  /**
   * Initialize the {@link org.dominokit.jacksonapt.ser.bean.IdentitySerializationInfo}. Returns
  ...
  /**
   * Initialize the {@link org.dominokit.jacksonapt.ser.bean.TypeSerializationInfo}. Returns null if
   ...
   * org.dominokit.jacksonapt.ser.bean.SubtypeSerializer}. Returns an empty map if the bean has no
   * subtypes.
   *
  ...
  /**
   * Initialize the {@link org.dominokit.jacksonapt.ser.bean.AnyGetterPropertySerializer}. Returns
   * null if there is no method annoted with {@link com.fasterxml.jackson.annotation.JsonAnyGetter}
   * on bean.
   *
