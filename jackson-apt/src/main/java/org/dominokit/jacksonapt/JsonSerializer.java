...
public abstract class JsonSerializer<T> {
   ...
   *
   * @param writer {@link org.dominokit.jacksonapt.stream.JsonWriter} used to write the serialized
   *     JSON
   * @param value Object to serialize
   * @param ctx Context for the full serialization process
   * @throws org.dominokit.jacksonapt.exception.JsonSerializationException if an error occurs during
   *     the serialization
   */
