...
public abstract class AbstractBeanJsonDeserializer<T> extends JsonDeserializer<T>
  ...
  /**
   * Initialize the {@link org.dominokit.jacksonapt.deser.bean.InstanceBuilder}. Returns null if the
  ...
  /**
   * Initialize the {@link org.dominokit.jacksonapt.deser.bean.MapLike} containing the property
  ...
  /**
   * Initialize the {@link org.dominokit.jacksonapt.deser.bean.MapLike} containing the back
   * reference deserializers. Returns an empty map if there are no back reference on the bean.
   *
   * @return a {@link org.dominokit.jacksonapt.deser.bean.MapLike} object.
   */
  ...
  /**
   * Initialize the {@link org.dominokit.jacksonapt.deser.bean.IdentityDeserializationInfo}. Returns
  ...
  /**
   * Initialize the {@link org.dominokit.jacksonapt.deser.bean.TypeDeserializationInfo}. Returns
   * null if there is no {@link com.fasterxml.jackson.annotation.JsonTypeInfo} annotation on bean.
   *
   ...
   * org.dominokit.jacksonapt.deser.bean.SubtypeDeserializer}. Returns an empty map if the bean has
   * no subtypes.
   *
  ...
  /**
   * Initialize the {@link org.dominokit.jacksonapt.deser.bean.AnySetterDeserializer}. Returns null
   * if there is no method annoted with {@link com.fasterxml.jackson.annotation.JsonAnySetter} on
   * bean.
   *
   ...
   * org.dominokit.jacksonapt.exception.JsonDeserializationException}) or not.
   *
   * @return a boolean.
   */
