...
* 
* While the purpose of this class is primarily to be instantiated by gwt-jackson-apt itself and then just used by the user code, it is a public API.<br><br>
*  
...
* 
* Unlike all those other implementations however, this {@link TypeToken} is designed to operate in a GWT/J2CL environment, where Java reflection 
* - and therefore, the {@link Type} class on which all other implementations are based of - is not available. 
* 
* How to use:
* For simple, non-parameterized types like {@link String}, {@link Integer} or non-parameterized Java Beans:<br>
* <pre>TypeToken.of(String.class)</pre><br>
*
...
* <pre>new TypeToken&lt;List&lt;Map&lt;Integer, String&gt;&gt;(List.class, new TypeToken&lt;Map&lt;Integer, String&gt;&gt;(Map.class, TypeToken.of(Integer.class), TypeToken.of(String.class)) {}) {} </pre>
* <br>
* 
...
public class TypeToken<T> implements Comparable<TypeToken<T>> {
     ...
     * When called on {@code TypeToken<List<String>>} it will return {@code List.class}<br><br>
     * 
     ...
     * When called on {@code TypeToken<List<String>>} a single-element array with a type token {@code TypeToken<String>}<br> 
     * When called on {@code TypeToken<String[]>} a single-element array with a type token {@code TypeToken<String>} will be returned as well 
     */
