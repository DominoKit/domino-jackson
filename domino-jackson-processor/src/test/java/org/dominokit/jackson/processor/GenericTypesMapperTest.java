...
public class GenericTypesMapperTest {
  ...
  static GenericMapperWithString GENERICMAPPERWITHSTRING =
      new GenericTypesMapperTest_GenericMapperWithStringImpl();

  @JSONMapper
  interface GenericMapperWithInteger extends ObjectMapper<SimpleGenericBeanObject<Integer>> {}

  static GenericMapperWithInteger GENERICMAPPERWITHINTEGER =
      new GenericTypesMapperTest_GenericMapperWithIntegerImpl();

  @JSONMapper
  interface GenericMapperWithListOfInteger
      extends ObjectMapper<SimpleGenericBeanObject<List<Integer>>> {}

  static GenericMapperWithListOfInteger GENERICMAPPERWITHLISTOFINETEGR =
      new GenericTypesMapperTest_GenericMapperWithListOfIntegerImpl();

  @JSONMapper
  interface ChildOfGenericMapper extends ObjectMapper<ChildOfGenericObject> {}

  static ChildOfGenericMapper CHILDOFGENERICMAPPER =
      new GenericTypesMapperTest_ChildOfGenericMapperImpl();

  @JSONMapper
  interface GenericChildOfGenericMapper
      extends ObjectMapper<GenericChildOfGenericObject<String, Integer>> {}

  static GenericChildOfGenericMapper GENERICHILDOFGENERICOBJECTMAPPER =
      new GenericTypesMapperTest_GenericChildOfGenericMapperImpl();

  @Test
  public void testGenericObject() {
    SimpleGenericBeanObject<String> genericWithString =
        new SimpleGenericBeanObject<>(11, "String test");
    ...
    assertEquals(
        "{\"intField\":11,\"typeField\":\"String test\",\"genericArr\":[[\"hi\",\"there\"],[\"my\",\"name\",\"is\",\"gwt-jackson-apt\"]],\"str\":\"str\"}",
        GENERICMAPPERWITHSTRING.write(genericWithString));
    ...
    assertEquals(
        "{\"intField\":201,\"typeField\":42,\"genericArr\":[[101,202],null],\"str\":\"str\"}",
        GENERICMAPPERWITHINTEGER.write(genericWithInteger));

    SimpleGenericBeanObject<Integer> genericWithIntegerDeser =
        GENERICMAPPERWITHINTEGER.read(
            "{\"intField\":12,\"typeField\":142,\"genericArr\":[[1010, 2020], null],\"str\":\"str\"}");
  ...
  public void testGenericObjectWithCollection() {
    ...
    assertEquals(
        "{\"intField\":201,\"typeField\":[1,3,5],\"genericArr\":[[[1,2],[10,20]],[[1122,2211]]],\"str\":\"str\"}",
        GENERICMAPPERWITHLISTOFINETEGR.write(genericListOfInteger));

    genericListOfInteger =
        GENERICMAPPERWITHLISTOFINETEGR.read(
            "{\"intField\":8080,\"typeField\":[201,3,188,4],\"genericArr\":[[[1,2],[10,20, 30]],[[101]]],\"str\":\"test string\"}");
  ...
  public void testGenericObjectWithInheritance() {
    ...
    assertEquals(
        "{\"subField\":\"field in child class\",\"intField\":201,\"typeField\":\"generic type field\",\"genericArr\":null,\"str\":\"string field\"}",
        CHILDOFGENERICMAPPER.write(childOfGenericObjectWithString));

    childOfGenericObjectWithString =
        CHILDOFGENERICMAPPER.read(
            "{\"subField\":\"child class field\",\"intField\":2012,\"typeField\":\"field generic type\",\"str\":\"field string\"}");
  ...
  public void testGenericChildOfGenericObjectInheritance() {
    ...
    assertEquals(
        "{\"subField\":\"generic child field\",\"genericMap\":{\"key\":[1,2,3]},\"genericList\":null,\"intField\":11,\"typeField\":2012,\"genericArr\":null,\"str\":\"string field\"}",
        GENERICHILDOFGENERICOBJECTMAPPER.write(object));

    GenericChildOfGenericObject<String, Integer> objectDeser =
        GENERICHILDOFGENERICOBJECTMAPPER.read(
            "{\"subField\":\"child field generic\",\"genericMap\":{\"key\":[1,2,3]},\"genericList\":null,\"intField\":1101,\"typeField\":12,\"genericArr\":null,\"str\":\"string field\"}");
