...
public class PolymorphicTest {
  ...
  private PolymorphicBaseMapper BASEMAPPERINSTANCE =
      new PolymorphicTest_PolymorphicBaseMapperImpl();

  @JSONMapper
  interface ListPolymorphicParamMapper extends ObjectMapper<List<PolymorphicBaseInterface>> {}

  private ListPolymorphicParamMapper LISTMAPPER =
      new PolymorphicTest_ListPolymorphicParamMapperImpl();

  @JSONMapper
  interface PolymorphicGenericClassParamMapper
      extends ObjectMapper<PolymorphicGenericClass<PolymorphicBaseInterface>> {}

  private PolymorphicGenericClassParamMapper POLYMORPHICMAPPER =
      new PolymorphicTest_PolymorphicGenericClassParamMapperImpl();
  ...
  public void testSubtypeWithWildcards() {
    ...
    PolymorphicGenericClass<PolymorphicBaseInterface> pgc_processed =
        POLYMORPHICMAPPER.read(jsonStr);
    assertEquals(PolymorphicChildClass.class, pgc_processed.data.getClass());
    assertEquals(
        ((PolymorphicChildClass) pgc.data).str, ((PolymorphicChildClass) pgc_processed.data).str);

    assertEquals(2, pgc_processed.dataList.size());
    assertEquals(PolymorphicChildClass.class, pgc_processed.dataList.get(0).getClass());
    assertEquals(
        ((PolymorphicChildClass) pgc.dataList.get(0)).str,
        ((PolymorphicChildClass) pgc_processed.dataList.get(0)).str);
    assertEquals(
        ((PolymorphicChildClass) pgc.dataList.get(0)).i,
        ((PolymorphicChildClass) pgc_processed.dataList.get(0)).i);
    assertEquals(
        ((PolymorphicChildClass2) pgc.dataList.get(1)).ii,
        ((PolymorphicChildClass2) pgc_processed.dataList.get(1)).ii);
    assertEquals(
        ((PolymorphicChildClass2) pgc.dataList.get(1)).i,
        ((PolymorphicChildClass2) pgc_processed.dataList.get(1)).i);
    ...
    assertEquals(
        ((SecondPolymorphicChildClass) pgc.dataListSecond.get(0)).str,
        ((SecondPolymorphicChildClass) pgc_processed.dataListSecond.get(0)).str);
    ...
    assertEquals(
        ((PolymorphicChildClass) pgc.dataMap.get(101)).str,
        ((PolymorphicChildClass) pgc_processed.dataMap.get(101)).str);
    assertEquals(pgc.dataMap.get(102).getClass(), pgc_processed.dataMap.get(102).getClass());
    assertEquals(
        ((PolymorphicChildClass2) pgc.dataMap.get(102)).ii,
        ((PolymorphicChildClass2) pgc_processed.dataMap.get(102)).ii);
  }
    ...
    CompilationTask task =
        compiler.getTask(
            ...
            fileManager.getJavaFileObjects(
                ...
                new File(
                    "src/test/java/org/dominokit/jacksonapt/processor/PolymorphicBaseInterface.java"),
                new File(
                    "src/test/java/org/dominokit/jacksonapt/processor/PolymorphicBaseClass.java"),
                new File(
                    "src/test/java/org/dominokit/jacksonapt/processor/PolymorphicChildClass.java"),
                new File(
                    "src/test/java/org/dominokit/jacksonapt/processor/PolymorphicChildClass2.java"),
                new File(
                    "src/test/java/org/dominokit/jacksonapt/processor/SecondPolymorphicBaseClass.java"),
                new File(
                    "src/test/java/org/dominokit/jacksonapt/processor/SecondPolymorphicChildClass.java"),
                new File(
                    "src/test/java/org/dominokit/jacksonapt/processor/SimpleGenericBeanObject.java"),
                new File(
                    "src/test/java/org/dominokit/jacksonapt/processor/PolymorphicGenericClass.java")));
