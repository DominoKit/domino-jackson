...
@CustomSerializer(Person.class)
public class PersonCustomBeanSerializer extends JsonSerializer<Person> {

  private static final PersonCustomBeanSerializer INSTANCE = new PersonCustomBeanSerializer();

  public static PersonCustomBeanSerializer getInstance() {
    return INSTANCE;
  }
