...
import org.dominokit.jackson.deser.BaseDateJsonDeserializer.SqlTimestampJsonDeserializer;
...
import org.dominokit.jackson.deser.map.key.*;
import org.dominokit.jackson.ser.*;
import org.dominokit.jackson.ser.BaseDateJsonSerializer.DateJsonSerializer;
import org.dominokit.jackson.ser.BaseDateJsonSerializer.SqlDateJsonSerializer;
import org.dominokit.jackson.ser.BaseDateJsonSerializer.SqlTimeJsonSerializer;
...
import org.dominokit.jackson.ser.map.key.*;
...
public final class TypeRegistry implements RegistryWrapper {
  ...
  static {
    collectionsDeserializers.put(
        AbstractCollection.class.getCanonicalName(), AbstractCollectionJsonDeserializer.class);
    collectionsDeserializers.put(
        AbstractList.class.getCanonicalName(), AbstractListJsonDeserializer.class);
    collectionsDeserializers.put(
        AbstractQueue.class.getCanonicalName(), AbstractQueueJsonDeserializer.class);
    collectionsDeserializers.put(
        AbstractSequentialList.class.getCanonicalName(),
        AbstractSequentialListJsonDeserializer.class);
    collectionsDeserializers.put(
        AbstractSet.class.getCanonicalName(), AbstractSetJsonDeserializer.class);
    collectionsDeserializers.put(
        ArrayList.class.getCanonicalName(), ArrayListJsonDeserializer.class);
    collectionsDeserializers.put(
        Collection.class.getCanonicalName(), CollectionJsonDeserializer.class);
    ...
    collectionsDeserializers.put(
        LinkedHashSet.class.getCanonicalName(), LinkedHashSetJsonDeserializer.class);
    collectionsDeserializers.put(
        LinkedList.class.getCanonicalName(), LinkedListJsonDeserializer.class);
    collectionsDeserializers.put(List.class.getCanonicalName(), ListJsonDeserializer.class);
    collectionsDeserializers.put(
        PriorityQueue.class.getCanonicalName(), PriorityQueueJsonDeserializer.class);
    ...
    collectionsDeserializers.put(
        SortedSet.class.getCanonicalName(), SortedSetJsonDeserializer.class);
  ...
  /**
   * resetTypeRegistry Helper method to clean (reset) state of TypeRegistry. This action should be
   * performed on every APT run, since in some environments (such as Eclipse), the processor is
   * instantiated once and used multiple times. Without some cleanup we may end up with some
   * serializer/deserializers not generated due to TypeRegistry internal state saying that they
   * already exists.
   */
   ...
   * register.
   *
   * @param mapper a {@link org.dominokit.jackson.processor.TypeRegistry.ClassMapper} object.
   */
  ...
  public static TypeName getCustomSerializer(String type) {
    if (containsSerializer(type)) return customMappers.get(type).serializer;
  ...
  public static TypeName getCustomDeserializer(String type) {
    if (containsDeserializer(type)) return customMappers.get(type).deserializer;
   ...
   * @return a {@link org.dominokit.jackson.processor.TypeRegistry.ClassMapper} object.
   */
  ...
  private static TypeName getSerializer(String typeName) {
    if (simpleTypes.containsKey(typeName)) return get(typeName).serializer;
  ...
  public static TypeName getKeySerializer(String typeName) {
    if (keysMappers.containsKey(typeName)) return keysMappers.get(typeName).serializer;
    throw new TypeSerializerNotFoundException(typeName);
  }
  ...
  public static TypeName getKeyDeserializer(String typeName) {
    if (keysMappers.containsKey(typeName)) return keysMappers.get(typeName).deserializer;
  ...
  private static TypeName getDeserializer(String typeName) {
    if (simpleTypes.containsKey(typeName)) return simpleTypes.get(typeName).deserializer;
    throw new TypeDeserializerNotFoundException(typeName);
  }
  ...
  private static Class<?> getMapDeserializer(String mapType) {
    if (mapDeserializers.containsKey(mapType)) return mapDeserializers.get(mapType);
