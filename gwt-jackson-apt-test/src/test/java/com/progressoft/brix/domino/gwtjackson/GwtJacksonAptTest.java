...
public class GwtJacksonAptTest extends JacksonTestCase {
    ...
    @JSONMapper
    public interface BeanWithCollectionsTypeMapper extends ObjectMapper<BeanWithCollectionsType> {
    ...
    @JSONMapper
    public interface BeanWithMapsTypeMapper extends ObjectMapper<BeanWithMapsType> {
