...
package org.dominokit.jackson.client.stream;
...
public abstract class AbstractJsonWriterTest extends JacksonTestCase {
  ...
  public void testDoubles() {
    ...
    if (!System.getProperty("superdevmode").equals("on")) {
      // in compiled mode, the .0 are removed, the power is written with 'e+' instead of 'E' and
      // 'e-' instead of 'E-' and the Double
      // .MIN_VALUE is 5e-324
      assertEquals(
          "[0,"
              + "1,"
  ...
  @Ignore
  // the JSON utils is being removed and JSON.stringify is being used instead of
  // JSONUtils.escapeValue
