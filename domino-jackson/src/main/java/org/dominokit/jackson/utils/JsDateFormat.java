...
package org.dominokit.jackson.utils;
...
import org.dominokit.jackson.deser.map.key.JsDateKeyParser;
...
public final class JsDateFormat implements JacksonContext.DateFormat {
   ...
   */
  public static final DateTimeFormat DATE_FORMAT_STR_ISO8601 =
      DateTimeFormat.getFormat("yyyy-MM-dd'T'HH:mm:ss.SSSZ");

  /** Same as 'regular' 8601, but handles 'Z' as an alias for "+0000" (or "GMT") */
  public static final DateTimeFormat DATE_FORMAT_STR_ISO8601_Z =
  ...
  public static final DateTimeFormat DATE_FORMAT_STR_RFC1123 =
      DateTimeFormat.getFormat("EEE, dd MMM yyyy HH:mm:ss zzz");
   ...
   * {@inheritDoc}
   *
   * <p>Format a date using {@link JsonSerializerParameters} or default values : {@link
   ...
   * {@inheritDoc}
   *
   * <p>Format a date using the {@link DateTimeFormat} given in parameter and {@link #UTC_TIMEZONE}.
   */
   ...
   * {@inheritDoc}
   *
   * <p>Format a date using {@link #DATE_FORMAT_STR_ISO8601} and {@link TimeZone} given in parameter
   */
  ...
  /**
   * Format a date using the {@link org.gwtproject.i18n.shared.DateTimeFormat} and {@link
   * org.gwtproject.i18n.client.TimeZone} given in parameters
   *
