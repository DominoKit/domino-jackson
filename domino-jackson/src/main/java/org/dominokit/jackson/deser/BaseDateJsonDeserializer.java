...
/** Base implementation of {@link org.dominokit.jackson.JsonDeserializer} for dates. */
public abstract class BaseDateJsonDeserializer<D extends Date> extends JsonDeserializer<D> {
  ...
  public static final class DateJsonDeserializer extends BaseDateJsonDeserializer<Date> {
    ...
    protected Date deserializeString(
        String date, JsonDeserializationContext ctx, JsonDeserializerParameters params) {
  ...
  public static final class SqlDateJsonDeserializer
      extends BaseDateJsonDeserializer<java.sql.Date> {
    ...
    protected java.sql.Date deserializeString(
      ...
      return new java.sql.Date(
          JacksonContextProvider.get()
              .dateFormat()
              .parse(ctx.isUseBrowserTimezone(), SQL_DATE_FORMAT, false, date)
              .getTime());
    }
  }
  ...
  public static final class SqlTimestampJsonDeserializer
