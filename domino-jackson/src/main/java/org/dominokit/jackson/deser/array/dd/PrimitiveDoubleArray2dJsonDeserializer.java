...
/** Default {@link org.dominokit.jackson.JsonDeserializer} implementation for 2D array of double. */
public class PrimitiveDoubleArray2dJsonDeserializer
    extends AbstractArray2dJsonDeserializer<double[][]> {

  private static final PrimitiveDoubleArray2dJsonDeserializer INSTANCE =
      new PrimitiveDoubleArray2dJsonDeserializer();

  /**
   * getInstance
   *
   * @return an instance of {@link
   *     org.dominokit.jackson.deser.array.dd.PrimitiveDoubleArray2dJsonDeserializer}
   */
