...
/**
 * Default {@link org.dominokit.jackson.JsonDeserializer} implementation for {@link java.util.List}.
 * The deserialization process returns an {@link java.util.ArrayList}.
 *
...
public final class ListJsonDeserializer<T> extends BaseListJsonDeserializer<List<T>, T> {
   ...
   *     objects inside the {@link java.util.List}.
   * @param <T> Type of the elements inside the {@link java.util.List}
   * @return a new instance of {@link org.dominokit.jackson.deser.collection.ListJsonDeserializer}
   */
