...
/**
 * Default {@link org.dominokit.jackson.JsonDeserializer} implementation for {@link java.util.Set}.
 * The deserialization process returns a {@link java.util.LinkedHashSet}.
 *
...
public final class SetJsonDeserializer<T> extends BaseSetJsonDeserializer<Set<T>, T> {
   ...
   *     objects inside the {@link java.util.Set}.
   * @param <T> Type of the elements inside the {@link java.util.Set}
   * @return a new instance of {@link org.dominokit.jackson.deser.collection.SetJsonDeserializer}
   */
