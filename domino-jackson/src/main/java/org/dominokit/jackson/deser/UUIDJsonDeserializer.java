...
/**
 * Default {@link org.dominokit.jackson.JsonDeserializer} implementation for {@link java.util.UUID}.
 */
public class UUIDJsonDeserializer extends JsonDeserializer<UUID> {
   ...
   * getInstance.
   *
   * @return an instance of {@link org.dominokit.jackson.deser.UUIDJsonDeserializer}
   */
