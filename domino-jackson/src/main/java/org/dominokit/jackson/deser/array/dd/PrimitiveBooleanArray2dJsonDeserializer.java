...
/**
 * Default {@link org.dominokit.jackson.JsonDeserializer} implementation for 2D array of boolean.
 */
public class PrimitiveBooleanArray2dJsonDeserializer
    extends AbstractArray2dJsonDeserializer<boolean[][]> {

  private static final PrimitiveBooleanArray2dJsonDeserializer INSTANCE =
      new PrimitiveBooleanArray2dJsonDeserializer();

  /**
   * getInstance
   *
   * @return an instance of {@link
   *     org.dominokit.jackson.deser.array.dd.PrimitiveBooleanArray2dJsonDeserializer}
   */
