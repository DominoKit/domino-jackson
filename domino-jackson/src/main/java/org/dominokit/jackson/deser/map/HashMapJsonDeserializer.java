...
public final class HashMapJsonDeserializer<K, V>
   ...
   * @param <K> Type of the keys inside the {@link java.util.HashMap}
   * @param <V> Type of the values inside the {@link java.util.HashMap}
   * @return a new instance of {@link org.dominokit.jackson.deser.map.HashMapJsonDeserializer}
   */
  public static <K, V> HashMapJsonDeserializer<K, V> newInstance(
   ...
   */
  private HashMapJsonDeserializer(
      KeyDeserializer<K> keyDeserializer, JsonDeserializer<V> valueDeserializer) {
