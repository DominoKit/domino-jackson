...
import org.dominokit.jackson.stream.impl.NonBufferedJsonReader;
...
public class DefaultJsonDeserializationContext implements JsonDeserializationContext {
   ...
   *   <when-type-assignable class="org.dominokit.jackson.JsonDeserializationContext.Builder" />
   * </replace-with>
   *
   * }</pre>
   */
   ...
   * builder
   *
   * @return a {@link org.dominokit.jackson.DefaultJsonDeserializationContext.Builder} object.
   */
