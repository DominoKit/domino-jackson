...
/**
 * {@link org.dominokit.jackson.ser.map.key.KeySerializer} implementation that uses {@link
...
public final class ToStringKeySerializer extends KeySerializer<Object> {
   ...
   * getInstance
   *
   * @return an instance of {@link org.dominokit.jackson.ser.map.key.ToStringKeySerializer}
   */
