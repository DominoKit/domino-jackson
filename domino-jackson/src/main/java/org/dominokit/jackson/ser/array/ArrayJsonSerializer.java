...
/**
 * Default {@link org.dominokit.jackson.JsonSerializer} implementation for array.
 *
...
public class ArrayJsonSerializer<T> extends JsonSerializer<T[]> {
   ...
   *     inside the array.
   * @param <T> Type of the elements inside the array
   * @return a new instance of {@link org.dominokit.jackson.ser.array.ArrayJsonSerializer}
   */
