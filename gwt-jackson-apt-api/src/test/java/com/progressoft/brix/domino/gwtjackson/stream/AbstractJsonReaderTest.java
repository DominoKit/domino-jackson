...
import static com.progressoft.brix.domino.gwtjackson.stream.JsonToken.*;
...
public abstract class AbstractJsonReaderTest extends JacksonTestCase {
    ...
    public void testNextJavaScriptObjectRootObject() {
        ...
        Person person = Js.cast(reader.nextObject( true ));
        ...
        person = Js.cast(reader.nextObject( false ));
        assertEquals( "Bob", person.getFirstName() );
        assertEquals( "Morane", person.getLastName() );
        assertEquals( JsonToken.END_DOCUMENT, reader.peek() );
    }
    ...
    public void testNextJavaScriptObjectRootArray() {
        ...
        JsArrayString array = Js.cast(reader.nextObject( true ));
        ...
        array = Js.cast(reader.nextObject( false ));
        assertEquals( 2, array.length() );
        assertEquals( "Bob", array.get( 0 ) );
        assertEquals( "Morane", array.get( 1 ) );
        assertEquals( JsonToken.END_DOCUMENT, reader.peek() );
    ...
    public void testNextJavaScriptObjectNoRootArray() {
        ...
        assertEquals( "jso", reader.nextName() );
        JsArrayMixed array = Js.cast(reader.nextObject( true ));
