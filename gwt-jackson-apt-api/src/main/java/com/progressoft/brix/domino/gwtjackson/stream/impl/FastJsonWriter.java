 ...
 * @version $Id: $
 */
public class FastJsonWriter implements com.progressoft.brix.domino.gwtjackson.stream.JsonWriter {
  ...
  private BufferStack<Integer> stack = new ElementalArrayBufferStack<Integer>();
  ...
  private void string(String value) {
    out.append(Global.JSON.stringify( value ));
  }
