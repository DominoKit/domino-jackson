...
public abstract class AbstractBeanJsonSerializer<T> extends JsonSerializer<T> implements InternalSerializer<T> {
     ...
     * serialize.
     *
     * @return an array of {@link com.progressoft.brix.domino.gwtjackson.ser.bean.BeanPropertySerializer} objects.
     */
     ...
     *
     * @return a {@link com.progressoft.brix.domino.gwtjackson.ser.bean.AnyGetterPropertySerializer} object.
     */
