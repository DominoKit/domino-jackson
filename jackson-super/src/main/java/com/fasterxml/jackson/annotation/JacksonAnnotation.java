 ...
 * part of Jackson package. Can be used for recognizing all Jackson annotations generically, and in
 * future also for passing other generic annotation configuration.
 */
