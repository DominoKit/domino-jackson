...
public abstract class AbstractArray2dJsonDeserializer<T> extends JsonDeserializer<T> {
     ...
     * @param deserializer a {@link com.progressoft.brix.domino.jacksonapt.JsonDeserializer} object.
     * @param params       a {@link JsonDeserializerParameters} object.
     * @param token        a {@link com.progressoft.brix.domino.jacksonapt.stream.JsonToken} object.
     * @param <C>          a C object.
